...
created_at_or_after_micros = now_micros()

request_uri, url = get_request_uri_and_url_from_extension('orders')

payload = {"type": "LIMIT", "side": "BUY", "quantity": "1.00000", "price": "17000.00", "baseAssetID": base_asset_id, "quoteAssetID": quote_asset_id, "durationType": "GOOD_TILL_EXPIRY", "customerObjectID": now_micros(), "expiresAtMicros": int(int(now_micros()) + 10*1e6)}
...
created_before_micros = now_micros()
