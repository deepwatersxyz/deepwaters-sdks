...
def sync_nonce(api_key, api_secret, nonce_d):
    ...
    request_uri, url = get_request_uri_and_url_from_extension(host_url, api_route, extension)
...
request_uri, url = get_request_uri_and_url_from_extension(host_url, api_route, 'orders')
