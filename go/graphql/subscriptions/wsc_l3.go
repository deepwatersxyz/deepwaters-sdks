...
func (wsc *websocketClient) setupL3() error {
	variables := ""
...
func (wsc *websocketClient) parseAndOutputL3(wMessage wrappedReceivedMessage) {
	...
	for _, order := range d.Data.Orders {
		wsc.l3OutputChannel <- order
	}
}
